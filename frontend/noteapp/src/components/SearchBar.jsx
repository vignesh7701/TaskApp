...
const SearchBar = ({ value, onChange, handleSearch, onClearSearch }) => {
  return (
    <div className="w-48 lg:w-80 flex items-center px-5   bg-blue-50 rounded-md">
    ...
    {value && <X className="text-xl text-blue-950 cursor-pointer" onClick={onClearSearch} />}
     {   !value && <Search className="text-lg cursor-pointer text-blue-950" onClick={handleSearch} />}
    </div>
  );
};
